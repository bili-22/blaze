...
export const Hex2Command = Object.fromEntries(Object.entries(Command2Hex).map((i) => i.reverse()));

export const Message2Hex = {
...
export const Hex2Message = Object.fromEntries(Object.entries(Message2Hex).map((i) => i.reverse()));

export type Method = keyof typeof Command2Hex | keyof typeof Message2Hex | 'KeepAlive';
